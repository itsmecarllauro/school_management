...
<body class="bg-gray-100 min-h-screen">
    <nav class="bg-white shadow p-6 flex justify-between items-center max-w-7xl mx-auto">
        <h1 class="text-2xl font-extrabold text-blue-700">Analytics</h1>
    ...
    <main class="p-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section class="bg-white p-6 rounded-lg shadow">
                <h2 class="text-xl font-semibold mb-4">User Registrations (Last 30 Days)</h2>
                <canvas id="userRegistrationsChart"></canvas>
            </section>
            <section class="bg-white p-6 rounded-lg shadow">
                <h2 class="text-xl font-semibold mb-4">Contacts Added (Last 30 Days)</h2>
