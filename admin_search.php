...
<body class=" min-h-screen">
    ...
    <main class="p-8 max-w-7xl mx-auto">
        ...
        <form method="GET" action="admin_search.php" class="mb-8 max-w-md">
            <input type="text" name="q" placeholder="Search users and contacts..." value="<?= htmlspecialchars($search) ?>" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 " style="--tw-ring-color: #B85042;"/>
            <button type="submit" class="mt-4 text-white px-6 py-3 rounded-lg font-semibold"  style="background-color: #B85042">Search</button>
        </form>
                        ...
                        <tbody>
                            <?php foreach ($users as $user): ?>
                                <tr class="border-t border-gray-200 hover:bg-blue-50 transition">
                                    ...
                                    <td class="py-3 px-6">
<a href="admin_users.php?edit=<?= $user['id'] ?>&return=admin_search.php" class="text-blue-600 font-semibold">Edit</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                            ...
                            <?php foreach ($contacts as $contact): ?>
                                <tr class="border-t border-gray-200 hover:bg-blue-50 transition">
                                    ...
                                    <td class="py-3 px-6 space-x-4">
                                        <a href="edit_contact.php?id=<?= $contact['id'] ?>&return=admin_search.php" class="text-blue-600 font-semibold">Edit</a>
